...
│${tz} ${xxx}DONASI?? KETIK ${prefix}donasi${xxx}
│${tz} ${xxx}OWNER?? KETIK ${prefix}owner${xxx}
...
exports.allmenu = (ownername, auth0r, bulan, tchat, tz, prefix) => {
	return`╭──❲ ${xxx}KABANERI-BOT${xxx} ❳
│${tz} ${xxx}OWNER : ${ownername}${xxx}
│${tz} ${xxx}SC : https://github.com/ZansLord/KABANE-BOT${xxx}
│${tz} ${xxx}AUTHOR : ${auth0r}${xxx}
│${tz} ${xxx}BULAN : ${bulan}${xxx}
│${tz} ${xxx}CHAT : ${tchat}${xxx}
╰──❲ 2022 ❳
